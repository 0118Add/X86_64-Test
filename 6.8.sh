...
# fullconenat-nft
merge_package https://github.com/immortalwrt/immortalwrt immortalwrt/package/utils/fullconenat-nft
# libnftnl
...
merge_package https://github.com/immortalwrt/immortalwrt immortalwrt/package/network/config/firewall4
git clone --depth=1 -b openwrt-23.05 https://github.com/Lienol/openwrt Lienol-openwrt
cp -rf openwrt-openwrt/package/network/utils/fullconenat package/new/fullconenat
