...
sed -i 's/PKG_RELEASE:=.*/PKG_RELEASE:=2/g' packages/utils/dockerd/Makefile
curl -s https://raw.githubusercontent.com/0118Add/X86_64-Test/main/general/patches/001-skip-copy-nested-binaries.patch > packages/utils/dockerd/patches/001-skip-copy-nested-binaries.patch
