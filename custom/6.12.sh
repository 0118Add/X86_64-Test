...
curl -s https://raw.githubusercontent.com/0118Add/X86_64-Test/refs/heads/main/patch/patches-6.12/999-fix-nf_conntrack_ecache-unused-warning.patch > target/linux/x86/patches-6.12/999-fix-nf_conntrack_ecache-unused-warning.patch
# kernel patch
