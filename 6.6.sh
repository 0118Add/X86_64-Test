...
# 替换文件
#wget -O ./feeds/luci/modules/luci-mod-status/htdocs/luci-static/resources/view/status/include/10_system.js https://raw.githubusercontent.com/0118Add/X86_64-Test/main/10_system.jsgit clone -b master --depth 1 https://github.com/BROBIRD/openwrt-r8168.git package/r8168
